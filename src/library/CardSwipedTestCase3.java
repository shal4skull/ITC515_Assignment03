...
public class CardSwipedTestCase3 {
	...
	// Testing postConditions: member exists and is restricted.
	@Test
	public void testCardSwiped() {
		...
		// The member has reached the fine limit.
		member.addFine(11);
...
// The result returns "BORROWING_RESTRICTED" state as expected.
